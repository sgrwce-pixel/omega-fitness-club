  ...
  return (
    <section id="facility" className="container-x py-24 lg:py-32">
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="img-zoom shake-on-hover data-inview-shake-placeholder col-span-12 md:col-span-8 rounded-lg overflow-hidden"><img src={dumbbells.url} alt="Hammer Strength dumbbells" className="h-[360px] w-full object-cover" /></div>
        <div className="img-zoom shake-on-hover data-inview-shake-placeholder col-span-12 md:col-span-4 rounded-lg overflow-hidden hover-lift"><img src={stronger.url} alt="Stronger than you think" className="h-[360px] w-full object-cover" /></div>
        <div className="img-zoom shake-on-hover data-inview-shake-placeholder col-span-12 md:col-span-5 rounded-lg overflow-hidden hover-lift"><img src={cableMachine.url} alt="Cable machines" className="h-[320px] w-full object-cover" /></div>
        <div className="img-zoom shake-on-hover data-inview-shake-placeholder col-span-12 md:col-span-4 rounded-lg overflow-hidden"><img src={stayStrong.url} alt="Stay strong poster" className="h-[320px] w-full object-cover" /></div>
