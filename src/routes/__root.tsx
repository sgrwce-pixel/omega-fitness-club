...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Omega Fitness — Gym in Beni Khiar, Tunisia" },
      { property: "og:description", content: "Premium equipment, expert coaches, real results. Strength, cardio, group classes & personal training in Beni Khiar." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://omega-fitness-club.lovable.app" },
      { property: "og:site_name", content: "Omega Fitness" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Omega Fitness — Gym in Beni Khiar, Tunisia" },
      { name: "twitter:description", content: "Premium equipment, expert coaches, real results in Beni Khiar, Tunisia." },
