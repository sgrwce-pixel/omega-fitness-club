...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Omega Fitness Club — Gym & Wellness in Beni Khiar" },
      { name: "description", content: "Omega Fitness Club in Beni Khiar, Tunisia: premium strength & cardio gear, expert coaches, group classes and personal training. Open daily until 11pm." },
      { property: "og:title", content: "Omega Fitness Club — Gym & Wellness in Beni Khiar" },
      { property: "og:description", content: "Omega Fitness Club in Beni Khiar, Tunisia: premium strength & cardio gear, expert coaches, group classes and personal training. Open daily until 11pm." },
      ...
      { name: "twitter:title", content: "Omega Fitness Club — Gym & Wellness in Beni Khiar" },
      { name: "twitter:description", content: "Omega Fitness Club in Beni Khiar, Tunisia: premium strength & cardio gear, expert coaches, group classes and personal training. Open daily until 11pm." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://omega-fitness-club.lovable.app/__l5e/assets-v1/2bb8940e-78f6-4594-8570-8f495a1d40d6/omega-logo.jpg",
