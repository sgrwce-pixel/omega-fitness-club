...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  plans: [
    { name: "1 Month", price: "60", per: "DT / month", feats: ["Fitness + Cardio access", "Locker room"] },
    { name: "3 Months", price: "160", per: "DT / 3 months", feats: ["Fitness + Cardio access", "Locker room"] },
    { name: "6 Months", price: "300", per: "DT / 6 months", feats: ["Fitness + Cardio access", "Locker room"] },
    { name: "12 Months", price: "570", per: "DT / year", feats: ["Fitness + Cardio access", "Locker room", "Best value"] },
  ],
